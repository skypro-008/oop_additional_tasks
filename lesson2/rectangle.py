...
- from_diagonal(cls, diagonal): класс-метод, принимающий диагональ прямоугольника и возвращающий объект класса Rectangle
- is_square(cls, width, height): статический метод, принимающий ширину и высоту прямоугольника и возвращающий True,
